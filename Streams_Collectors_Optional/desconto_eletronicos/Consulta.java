...
public class Consulta {
    ...
    public static List<Produto> aplicar15PorcentoDescontoEletronicos(List<Produto> products) {
        return products.stream()
                .map(eletronicProduct -> {
                    if (eletronicProduct.getCategoria() == CategoriaProduto.ELETRONICO)
                        eletronicProduct.setPreco(0.85*eletronicProduct.getPreco());
